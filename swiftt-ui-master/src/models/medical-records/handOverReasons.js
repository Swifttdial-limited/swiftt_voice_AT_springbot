...
import { create, remove, update, query } from '../../services/medical-records/handOverReasons';
import { parse } from 'qs';

export default modelExtend(collectionModel, {

  namespace: 'handOverReasons',
  ...
  effects: {
    ...
    *delete({ payload }, { call, put }) {
      try {
        ...
        console.log('Error occured while deleting handover reason');
      }
    },
