...
import { create, remove, update, query } from '../../services/fixed-asset-mgt/maintenanceCategories';

export default modelExtend(collectionModel, {

  namespace: 'fixed_asset_maintenance_categories',
  ...
  effects: {
    ...
    *create({ payload }, { call, put }) {
      ...
      try {
        ...
        if (data) {
          yield put({ type: 'query', payload: { groupType: data.groupType } });
        }
      } catch (e) {
        yield put({ type: 'queryFailure' });
      }
