...
import { queryOne, remove, update, applyAction } from '../../services/fixed-asset-mgt/transfers';

export default modelExtend(resourceModel, {

  namespace: 'fixed_asset_transfer',
  ...
  subscriptions: {
    setup({ dispatch, history }) {
      history.listen((location) => {
        const match = pathToRegexp('/fixed-assets-management/transfer/view/:id').exec(location.pathname);
        if (match) {
