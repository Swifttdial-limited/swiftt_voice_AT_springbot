...
import { queryOne, remove, update, applyAction } from '../../services/fixed-asset-mgt/adjustments';

export default modelExtend(resourceModel, {

  namespace: 'fixed_asset_adjustment',
  ...
  subscriptions: {
    setup({ dispatch, history }) {
      history.listen((location) => {
        const match = pathToRegexp('/fixed-assets-management/adjustment/view/:id').exec(location.pathname);
        if (match) {
