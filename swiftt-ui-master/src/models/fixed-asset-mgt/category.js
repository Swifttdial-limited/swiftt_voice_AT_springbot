...
import { queryOne, remove, update, applyAction } from '../../services/fixed-asset-mgt/categories';

export default modelExtend(resourceModel, {

  namespace: 'fixed_asset_category',
  ...
  subscriptions: {
    setup({ dispatch, history }) {
      history.listen((location) => {
        const match = pathToRegexp('/fixed-assets-management/assetCategory/view/:id').exec(location.pathname);
        if (match) {
