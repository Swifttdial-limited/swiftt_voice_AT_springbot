...
import { queryOne, remove, update, applyAction } from '../../services/fixed-asset-mgt/disposal';

export default modelExtend(resourceModel, {

  namespace: 'fixed_asset_disposal',
  ...
  subscriptions: {
    setup({ dispatch, history }) {
      history.listen((location) => {
        const match = pathToRegexp('/fixed-assets-management/disposal/view/:id').exec(location.pathname);
        if (match) {
