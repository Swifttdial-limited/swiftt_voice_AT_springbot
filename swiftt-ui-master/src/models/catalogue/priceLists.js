...
import { create, query, update, remove, applyAction } from '../../services/catalogue/priceLists';

export default modelExtend(collectionModel, {

  namespace: 'catalogue_price_lists',
  ...
  effects: {
    ...
    *delete({ payload }, { call, put }) {
      ...
      try {
        ...
        console.log('Cannot delete price list type');
      }
    },
    ...
    *doBulkAddOrUpdate({ payload }, { select, call, put }) {
      yield put({ type: 'showLoading' });
