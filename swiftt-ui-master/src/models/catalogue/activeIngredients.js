...
import { create, remove, update, query } from '../../services/catalogue/activeIngredients';
import { parse } from 'qs';

export default modelExtend(collectionModel, {

  namespace: 'catalogue_activeingredients',
  ...
  effects: {
    ...
    *delete({ payload }, { call, put }) {
      ...
      try {
        ...
        console.log('Cannot delete active ingredient');
      }
    },
