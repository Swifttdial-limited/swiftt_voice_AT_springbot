...
import { create, query, update, remove } from '../services/nextOfKins';

export default modelExtend(collectionModel, {

  namespace: 'next_of_kins',
  ...
  effects: {
    ...
    *delete({ payload }, { call, put }) {
      ...
      try {
        ...
        yield put({ type: 'query', payload: { userId: payload.userId } });
      } catch (e) {
        console.log('Cannot delete next of kin');
      }
    },
