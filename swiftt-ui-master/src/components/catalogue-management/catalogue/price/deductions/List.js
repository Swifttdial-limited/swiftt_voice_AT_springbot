    ...
    const columns = [
      {
        ...
        dataIndex: 'deductionType.name',
        key: 'deductionType.name',
      }, {
        title: 'Type of Value',
        dataIndex: 'calculationStrategy',
        key: 'calculationStrategy',
        render: (text) => { return (<span>{text === 'PERCENTAGE' ? 'Percentage' : 'Value'}</span>); },
      }, {
        title: 'Value',
        dataIndex: 'value',
        key: 'value',
        ...
        title: 'Billable Wallet Type',
        dataIndex: 'billableWalletType.name',
        key: 'billableWalletType.name',
      }, {
        title: '',
        key: 'operation',
        width: 100,
