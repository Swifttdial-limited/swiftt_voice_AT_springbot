    ...
    const columns = [
      {
        ...
        title: 'Parent',
        dataIndex: 'parentAssetCategory',
        key: 'parentAssetCategory',
        //render: (text, record) => <Ellipsis lines={1}>{record.parentAssetCategory.assetCategoryName}</Ellipsis>,
        render: (text, record) => {
          return record.parentAssetCategory ? <Tag>{record.parentAssetCategory.assetCategoryName}</Tag> : null;
        },
      }, {
        title: 'Description',
