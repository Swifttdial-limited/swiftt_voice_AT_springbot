  ...
  return (
    <Row gutter={24}>
      <Col lg={12} md={12} sm={16} xs={24} style={{ marginBottom: 16 }}>
        <SearchDepartment {...searchDepartmentProps} />
      </Col>
      <Col lg={{ offset: 6, span: 6 }} md={12} sm={8} xs={24} style={{ marginBottom: 16, textAlign: 'right' }}>
        <Link to="/system-administration/department/create">
          <Button type="primary"><Icon type="plus" />New Department</Button>
        </Link>
      </Col>
    </Row>
  );
