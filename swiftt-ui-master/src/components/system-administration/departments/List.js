    ...
    const columns = [
      {
        ...
        title: 'Can Bill',
        dataIndex: 'billingAllowed',
        key: 'billingAllowed',
        render: text => <span>{text ? 'Yes' : 'No'}</span>,
      },
      // {
      //   title: 'Create Bill',
      //   dataIndex: 'billCreationAllowed',
      //   key: 'billCreationAllowed',
      //   render: text => <span>{text ? 'Yes' : 'No'}</span>,
      // }, 
      {
        title: 'Ward',
        ...
        title: 'Merchant',
        dataIndex: 'merchantDepartment',
        key: 'merchantDepartment',
        render: text => <span>{text ? 'Yes' : 'No'}</span>,
      }, {
        title: 'Has invoice',
        dataIndex: 'invoicingDepartment',
        key: 'invoicingDepartment',
        render: text => <span>{text ? 'Yes' : 'No'}</span>,
      }, {
        title: '',
        key: 'operation',
