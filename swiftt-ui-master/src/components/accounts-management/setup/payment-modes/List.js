    ...
    const columns = [
      {
        ...
        dataIndex: 'bank',
        key: 'bank',
        render: (text, record) => <span>{text ? 'Bank' : 'Cash'}</span>
      }, {
        title: 'Currency',
        dataIndex: 'tradingCurrency.currency.name',
        key: 'tradingCurrency.currency.name',
        render: (text) => <Ellipsis lines={1}>{text}</Ellipsis>,
      }, {
        title: 'Ref. Required',
        dataIndex: 'paymentReferenceRequired',
        key: 'paymentReferenceRequired',
