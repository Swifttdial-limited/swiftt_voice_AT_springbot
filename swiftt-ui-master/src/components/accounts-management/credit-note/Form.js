...
class CreditNoteForm extends PureComponent {
  ...
  render() {
        ...
        if (!err) {
          ...
          if (approvedItems.length > 0) {
            confirm({
              ...
              onOk() {
                onApprove(values.items.filter(creditNoteItem => creditNoteItem.approved));
              },
            });
          } else {
    ...
    getFieldDecorator('receiptNote', { initialValue: creditNote.receiptNote ? creditNote.receiptNote : null});
            ...
            <Col span={18}>
              {creditNote.id ? (
                ...
                <Fragment>
                  <FormItem label="Vendor:" hasFeedback {...headerFormItemLayout}>
                    {getFieldDecorator('vendor', {
                      initialValue: creditNote.vendor ? creditNote.vendor : null,
                      rules: [
                        {
                          required: true,
                      ...
                      editValue={creditNote.vendor ? creditNote.vendor.name : null}
                  ...
                  {getFieldValue('vendor') && (
                    <FormItem label="Purchase Invoice Ref:" hasFeedback {...headerFormItemLayout}>
                      {getFieldDecorator('receiptNote', {
                        initialValue: creditNote.receiptNote ? creditNote.receiptNote : null,
                        rules: [
                          {
                            required: true,
                          ...
                          vendor={getFieldValue('vendor').publicId}
                          status="APPROVED"
                          onPurchaseInvoiceSelect={this.receiptNoteSelectHandler} />)}
                    </FormItem>
                  )}
                </Fragment>
              )}
              ...
              <FormItem label="Credit Note No:" hasFeedback {...headerFormItemLayout}>
                {getFieldDecorator('creditNoteReference', {
                  ...
                  rules: [
                    {
                      required: true,
                      message: 'Credit Note number must be specified',
                    },
                  ],
                })(<Input />)}
              </FormItem>
