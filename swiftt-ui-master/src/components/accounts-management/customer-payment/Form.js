          ...
          <Row gutter={24}>
            <Col span={16}>
              ...
              <FormItem label="Payment Mode:" hasFeedback {...headerFormItemLayout}>
                {getFieldDecorator('payment.paymentMode', {
                  initialValue: customerPayment.payment ? customerPayment.payment.paymentMode : null,
                  rules: [
                    {
                      required: true,
                  ...
                  editValue={customerPayment.payment && customerPayment.payment.paymentMode ? customerPayment.payment.paymentMode.name : null}
                  {...paymentModeSelectProps}
                />)}
              </FormItem>
              <FormItem label="Reference:" hasFeedback {...headerFormItemLayout}>
                {getFieldDecorator('description', {
                  initialValue: customerPayment.description ? customerPayment.description : null,
                  rules: [
                    {
                      required: true,
              ...
              <FormItem label="Payment Date:" hasFeedback {...headerFormItemLayout}>
                {getFieldDecorator('paymentDate', {
                  initialValue: customerPayment.paymentDate ? moment(customerPayment.paymentDate, dateFormat) : moment(moment().format(dateFormat), dateFormat),
                  rules: [
                    {
                      required: true,
