...
class list extends PureComponent {
  ...
  render() {
    ...
    const columns = [
      {
        title: 'Receipt Note No.',
        dataIndex: 'receiptNoteNumber',
        ...
        title: 'Type',
        dataIndex: 'receiptNoteType',
        key: 'receiptNoteType',
        align: 'center',
        render: (text) => {
          if(text === 'GOODS')
            return <span>Goods</span>
        ...
        title: 'Status',
        dataIndex: 'receiptNoteStatus',
        key: 'receiptNoteStatus',
        align: 'center',
        render: (text, record) => <span>{renderReceiptNoteStatusTag(text)}</span>,
      }, {
        title: 'Total',
